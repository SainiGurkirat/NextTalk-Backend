...
// IMPORTANT: Serve static files from the backend's 'uploads' directory
// This maps '/uploads' URL path to the actual directory where files are stored.
// Assuming server.js is in 'backend/' and uploads are in 'backend/uploads'.
app.use('/uploads', express.static(path.join(__dirname, 'uploads')));
// REMOVED: app.use(express.static(path.join(__dirname, '../uploads/public'))); // This line is not needed with the new setup
